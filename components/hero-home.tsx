      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="py-5 md:py-10">
          ...
          <div className="pb-12 text-center md:pb-20">
            <h1
              className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.red.200),theme(colors.gray.50),theme(colors.red.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-5 font-nacelle text-7xl font-semibold text-transparent md:text-7xl"
              data-aos="fade-up"
            >
              {/* STRIDE */}
              Introducing PRAISE
            ...
            <h1
              ...
              data-aos="fade-up"
            >
              Patient Remote Assessment and Instant Screening Engine 
            </h1>
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                PRAISE is our newest product that enables patients to get screening with AI.
                </p>
              <h1
              ...
              <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
                ...
                <div data-aos="fade-up" data-aos-delay={400}>
                  <a
                    className="btn group mb-4 w-full bg-gradient-to-t from-red-600 to-red-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%]  sm:w-auto sm:ml-4"
